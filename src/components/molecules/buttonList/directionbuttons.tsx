...
export function DirectionButtons({ onLeftClick, onRightClick }: Props) {
  return (
    <FlexContainer>
      <Button onClick={onLeftClick} bgColor="#74B743" width={32} height={32} radius={50} margin="0px 8px 0px 0px">
        <Img alt="왼쪽방향" src={leftArrow} width={12} />
      </Button>
      <Button onClick={onRightClick} bgColor="#74B743" width={32} height={32} radius={50}>
